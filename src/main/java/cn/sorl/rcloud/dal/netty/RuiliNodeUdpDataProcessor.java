 ...
 * 00 00 00 00 10 10 10 10 10 00 00 00 01 02 02 10 44 65 66 75 61 6c 74 54 65 73 74 2f 32 30 32 30 3a 30 34 3a 30 34 54 31 32 3a 30 30 3a 30 31 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
 * @author  nesc420
 * @date    2019-4-8
 * @version 0.0.3
 */
public class RuiliNodeUdpDataProcessor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RuiliNodeUdpDataProcessor.class);
